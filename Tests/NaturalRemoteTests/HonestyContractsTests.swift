...
final class HonestyContractsTests: XCTestCase {
    ...
    func testThemeTokensMatchMASTER() {
        XCTAssertEqual(ClusterFuckPalette.primary, 0x8B5CF6)
        XCTAssertEqual(ClusterFuckPalette.secondary, 0x00A2FF)
        XCTAssertEqual(ClusterFuckPalette.accent, 0x45E0A8)
        XCTAssertEqual(ClusterFuckPalette.lightBackground, 0xF8FAFC)
        XCTAssertEqual(ClusterFuckPalette.darkBackground, 0x08091A)
        XCTAssertEqual(ClusterFuckPalette.destructive, 0xF5232B)
        XCTAssertEqual(ClusterFuckPalette.warning, 0xFF2F92)
